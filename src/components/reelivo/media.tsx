...
export function StillCard({
  ...
  return (
    <article
      className={`group ${fluid ? "w-full" : "w-[240px] shrink-0 snap-start md:w-[300px]"}`}
    >
      <div
        role="link"
        tabIndex={0}
        ...
        onFocus={onHover}
        className="relative aspect-video w-full cursor-pointer overflow-hidden rounded-xl bg-surface-2 ring-1 ring-white/[0.06] transition-all duration-200 group-hover:ring-white/25"
      >
        <Img
